...
.label-primary, .btn-primary {
    background-color(90deg,#664791 0,#bda6de 10%,#664791 51%,#bda6de 89%,#664791 100%);
...
.fr.borderg, .fr.borderg a {
    ...
    background-image: linear-gradient(90deg,#664791 0,#bda6de 10%,#664791 51%,#bda6de 89%,#664791 100%);
    border: #674992 solid 0px;
    color: #fff;
}
...
div#l2 input#u2,div#l3 input#u3 {
        ...
        background-image: linear-gradient(90deg,#664791 0,#bda6de 10%,#cab9e1 51%,#bda6de 89%,#664791 100%);
...
ul.nav.nav-tabs>li.active>a {
    color: #ffe000;
    background-image: linear-gradientt(90deg,#664791 0,#bda6de 10%,#664791 51%,#bda6de 89%,#664791 100%);
    border: none;
    border-radius: 3px;
}
